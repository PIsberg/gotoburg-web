          ...
          <div className="flex items-center justify-center md:justify-start border-y border-gray-100 py-4">
            ...
            <div className="flex space-x-3 text-gray-400">
              <a
                ...
                className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-blue-100 hover:text-blue-600 transition-colors"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-blue-800 hover:text-white transition-colors"
