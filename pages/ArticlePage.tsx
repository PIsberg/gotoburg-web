        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
           ...
           <div className="lg:col-span-8">
             <div className="prose prose-lg prose-slate font-serif max-w-none text-gray-800 leading-loose">
                ...
                <AdSense slot="in-article-fluid-777" format="fluid" className="my-8 py-4 border-y border-gray-100" label="Annons" />
           ...
           <aside className="lg:col-span-4">
              <div className="sticky top-24 space-y-8">
                <AdSense slot="article-sidebar-333" format="rectangle" label="Annons" />
